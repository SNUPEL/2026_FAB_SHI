...
| 구분 | 파일 |
|---|---|
| W/O 실적 | `input/260724_절단WO_데이터_None.xlsx` |
| 블록 실적 | `input/260724_절단블록_데이터_None.xlsx` |
...
- 실적 물리 블록 `(PROJ_NO, BLK_NO)`은 871개다.
...
최종 MIXED block-series 파일의 `MARK_LTH`는 신규 실적 계약에 따라 W/O 합계로 다시 집계한다.
