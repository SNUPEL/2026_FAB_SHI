...
# [수정 1] 선형식 + max(0, ...) 하한 절단은 짧은 블록을 체계적으로 0으로 만들어
# 실적 1.27% 대비 21.1%의 인공 영값을 발생시켰다(생성 결과 검증). 허들(0 여부)과
# 로그선형(양수 크기)을 분리한다. 로그선형은 실적 R^2 0.368 -> 0.741로 개선되고
# 지수함수라 음수가 구조적으로 나올 수 없어 하한 절단 자체가 불필요해진다.
BLOCK_MARK_LOG_A = 2.699929
BLOCK_MARK_LOG_B = -20.518245
BLOCK_MARK_LOG_STD = 0.873402
# 로그공간에서 정규 잔차를 쓰면 E[exp(eps)] = exp(sd^2/2) = 1.464배 만큼 평균이
# 과대추정된다(로그정규 편의). 실적 잔차는 왜도 -0.519로 비대칭이라 정규 가정이
# 맞지 않으므로, 실적 잔차를 그대로 부트스트랩하고 Duan smearing 보정계수를 적용한다.
BLOCK_MARK_LOG_RESIDUALS = np.array([
    -1.433141, -1.460881, 0.452149, -1.157818, 0.608120, 0.559087, -0.367454, 1.199506,
    -0.462566, 0.780459, -0.033102, -0.031240, 0.460075, -0.325889, -0.127521, -0.856078,
    0.228962, -0.941977, -1.088276, -2.258845, 0.820346, -0.775223, -0.941866, -2.484673,
    0.210911, -0.901186, -1.044052, -0.779925, 1.161394, 0.036536, -0.080304, -0.257050,
    1.158987, 0.147227, -0.240998, 0.111992, 1.230262, -0.001834, 0.668166, 0.270662,
    0.152230, 0.292496, 0.368532, -0.728695, -1.526350, -0.759379, -2.066798, -2.304098,
    -0.951430, -0.112608, -0.374165, -0.546429, -0.160476, 0.478713, -0.874694, -1.218528,
    0.833129, -0.047916, -0.801527, 0.270216, 0.017871, -0.942230, -0.709737, -0.123170,
    1.072327, 1.266138, 0.457278, 0.370769, 0.520760, -0.209773, -0.025694, 0.363977,
    0.309317, -0.065785, -1.459256, -0.247958, 0.277870, 0.522600, -0.250644, 0.566378,
    0.493877, 0.079042, 0.318183, -0.344411, 0.190119, 0.102365, -0.134152, 0.397169,
    0.385768, -0.795757, -0.340435, -0.754789, 0.287614, -0.329933, -0.663268, -0.367286,
    1.198324, 0.432566, 0.258883, -0.372521, 0.170768, 0.854251, -1.757517, 0.454255,
    -1.743041, 0.487918, 0.730419, -1.866768, 0.435888, 0.269784, -0.230056, 0.704773,
    1.211713, 1.729121, 1.863135, -0.753993, -0.192034, -2.707817, 0.462304, -2.174772,
    0.713509, 0.065756, -0.095409, 0.479096, 0.794051, 0.057577, -0.095409, 0.489127,
    -2.827153, 0.603016, 0.886145, 1.448861, -0.369466, -0.194695, -2.256387, 0.170445,
    0.344710, 0.474918, 0.588349, 1.000391, -0.061589, 1.491352, -1.279898, -0.051730,
    0.305637, -1.586647, -1.782608, -0.131495, 0.613272, -0.035594, 0.426260, -0.127411,
    -1.276783, 0.953112, -0.751249, 0.156176, -0.219030, -0.404411, -1.022745, -0.308748,
    -0.312996, -0.512873, -0.925641, 1.374726, 1.098763, -0.150162, -0.411897, 0.461397,
    -0.890198, 0.449964, 0.509732, -0.616043, 0.911840, 1.349206, 0.532252, 1.898556,
    1.151623, -0.117087, -0.039710, 0.486338, 0.582445, -0.028744, 0.310685, -0.577787,
    0.263403, -0.182697, 0.239562, 0.153413, -1.735021, -0.113445, -0.499508, -1.095045,
    -0.825710, 0.467826, 0.803036, 0.523401, -0.350277, 0.513426, -0.210400, -0.595636,
    0.801768, -0.998053, 0.133970, -0.360627, 0.325440, 0.653569, 0.544459, 0.228676,
    -1.159355, 0.908308, -0.727639, -0.461504, 1.317109, 0.594023, 0.769181, 1.013363,
    0.801768, 0.381996, -0.681141, 0.381996, 0.385749, -2.186197, 0.067313, 0.385749,
    0.550791, -0.883417, -1.518429, -1.945186, -0.111489, -2.106131, 1.234883, -0.477277,
    1.050665, 0.459298, -0.055279, 0.243508, 0.183726, 0.985801, 0.537986, 0.970392,
    0.144861, -0.597202, -1.127991, 1.131877, 0.896121, 0.328862, 1.365355, 0.598371,
    0.652777, 0.067313, 0.550791, 0.359251, 0.130048, 0.482569, -0.612585, 0.136190,
    -0.740049, 0.655099, -2.095710, 0.555523, -1.055726, 0.730760, -0.088102, -2.186197,
    0.148374, 0.590884, -0.883417, 0.836514, -1.713706, 0.593848, 0.326946, -1.518429,
    -1.945186, -0.111489, -2.106131, 1.234883, -0.477277, 0.459298, -0.807319, 0.091621,
    -0.055279, 0.243508, 0.183726, 0.985801, 0.537986, -0.015896, 0.336370, -0.297716,
    0.560311, -0.487167, -0.013112, 0.701106, 0.550791, 0.359251, 0.130048, 0.482569,
    -0.612585, 0.136190, -0.740049, -2.095710, 0.555523, 0.707945, -2.186197, 0.148374,
    0.590884, -0.883417, 0.836514, -1.713706, 0.593848, 0.326946, -1.329457, 0.056246,
    -0.530065, 0.364901, -0.361937, 0.102223, -0.343301, -1.246876, -0.111489, -0.554536,
    -0.433460, 0.052886, -0.563689, -1.298616, 1.234883, 0.303563, -0.477277, -0.240685,
    -1.273006, 1.068187, -0.883960, 1.113202, -1.015403, 0.976557, -0.630207, -1.538124,
    -0.398299, -0.805321, -0.636522, -0.394700, -0.432693, -0.554536, -0.563689, 0.303563,
    -0.240685, 0.789866, -0.132638, 0.432179, 0.051365, -0.265376, -0.486546, 0.626235,
    -1.001340, -0.378094, -0.052489, -0.097236, 0.044616, -0.850264, 0.350878, -0.769327,
    0.150972, -0.695295, 0.081668, -0.753017, -0.791213, -0.862672, -1.075184, -0.331124,
    -0.094532, -0.294615, -0.304332, -1.720118, -1.040460, -0.269490, -0.370753, -0.370757,
    0.105885, 0.158163, -0.312206, -0.539444, 0.104262, -0.010626, -0.737551, -0.228052,
    0.383502, 0.459880, 0.891401, -1.031433, 0.335584, 0.734120, 0.022489, 1.167565,
    1.650298, -0.360364, 0.463305, 0.587374, 0.104234, 0.162140, -2.660048, 1.004039,
    -0.236151, 0.565323, 0.070756, -0.688410, -1.254998, -1.152108, 0.240462, -0.100574,
    0.676374, 0.592231, 0.596183, 1.069166, 0.579074, 0.062141, -0.687970, 0.335501,
    1.136089, -0.239686, 0.018108, -0.145755, -2.060267, -0.541028, -1.550842, 2.525129,
    1.497666, 0.440851, 1.084949, 1.628493, 1.019920, 0.030303, 0.654966, 0.073228,
    -1.107371, -1.234377, 0.347787, 0.197893, -0.970306, -1.097084, -0.756255, -0.118579,
    0.223999, 0.586820, 1.064288, 0.065641, 0.556991, 1.089742, 0.059640, 0.503736,
    0.654423, -0.532696, -0.800005, 0.170682, -1.338491, -0.151980, -0.461063, -0.582539,
    1.447749, 0.963980, 0.395978, 1.042055, 0.409068, -0.440865, 0.047702, 1.036090,
    0.389468, -0.128358, -0.367564, 0.286902, 0.948968, 0.330869, 0.673684, -0.266375,
    -0.258436, -1.671620, 1.173948, 1.107930, 1.355807, 0.065060, 1.753574, -0.269208,
    0.115687, -0.131845, -1.405390, 0.643032, 0.029820, 0.033271, 1.103974, -0.062817,
    -0.866595, 0.489699, -0.270803, 1.470533, 0.234239, -0.469213, -0.234291, -1.976575,
    1.156390, -0.331381, 0.401814, -0.346591, 0.000187, 1.046532, -3.094355, 1.129638,
    -2.765891, 1.206843, 1.013559, 1.408205, -1.180738, 0.951731, 0.317968, 0.562959,
    -0.367547, -0.342032, 0.954480, 1.482823, 0.496164, -0.623686, 0.336134, 0.434341,
    0.084980, -0.598578, 0.017733, -0.995092, 0.273358, -0.849355, -0.184300, 0.812216,
    0.807127, 0.972765, 0.071579, 0.526763, -1.178073, -0.728252, -0.797668, 2.136422,
    -0.995092, 0.273358, 0.440851, -0.119691, 1.064288, -1.313754, 0.063024, 0.556991,
    -2.060267, 1.089742, -0.541028, 0.059640, 0.503736, -1.550842, 0.871064, 0.856220,
    0.625145, -0.151980, 2.525129, -0.171170, 1.501633, -1.133218, 1.459805, 1.169102,
    0.393592, 1.037317, 0.408801, -0.462895, 0.045629, -1.500719, 0.460505, 0.065060,
    -0.446703, -0.269208, 0.115687, -0.131845, -1.405390, 1.920935, -0.415101, -0.062817,
    1.628493, 1.019920, 0.320751, -1.267985, 0.954480, 0.953166, 0.782607, 0.479502,
    -0.319823, -0.843644, -0.273242, 0.929721, -0.774383, -0.942229, -0.526911, 0.161852,
    -1.107621, -1.234701, 0.439265, 1.176608, 0.622816, 0.633459, 0.322747, -0.569221,
    0.841397, 1.024146, 0.670254, 0.779205, 0.277296, 0.543566, -0.291162, -0.958505,
    0.721638, 0.093143, -0.317425, 0.374467, 0.449397, 0.423095, 1.253525, -0.853640,
    -1.011930, 0.259259, -1.157985, 0.067921, -0.153768, 0.514228, -0.818300, 0.885968,
    -0.270437, 1.688430, -0.126425, 0.104198, 0.747557, 0.546613, -1.233800, 0.859321,
    0.492493, -1.205585, -0.900345, -0.669650, 1.120286, 0.595808, 1.282025, 1.059488,
    1.211815, 0.214057, 0.691371, 0.762120, 0.617190, -0.247828, 1.213784, 1.189704,
    0.269296, -0.367467, -0.789095, 1.282332, -0.222395, -0.615366, 0.341739, -0.282299,
    0.074934, 1.166325, -2.286440, 1.204394, -2.057977, 1.194452, 1.179715, 1.388977,
    0.978644, 0.037372, 1.574577, -0.706233, 1.580669, 0.655743, -0.401157, 0.588373,
    1.042712, 0.323143, -0.564609, -0.411790, -0.536099, -0.139077, -0.132571, 0.731284,
    -0.887586, -1.399908, -0.054536, -1.140547, -1.266472, 0.283051, -0.536099, -0.827653,
    -0.010006, -1.106846, -1.227900, 0.732100, -1.687414, -0.321485, 0.929633, 0.387552,
    -0.314974, -1.512448, 0.437049, -1.448629, -0.173458, -0.535288, -1.030927, -0.038435,
    0.985988, 0.094010, -0.327151, 0.255259, 0.074983, -0.068445, -0.763243, 0.300897,
    0.738561, -0.403102, 0.888890, -0.605634, 0.485055, -0.218809, 0.796383, 0.021046,
    -1.604206, 1.077176, -0.974987, -0.101336, 0.432154, -0.556813, 0.708600, 1.214976,
    0.483786, -0.728301, -2.567455, 0.469713, -0.553516, 0.556130, 0.557124, 1.328007,
    0.536035, 0.151751, -0.498415, -0.035613, 0.815179, -0.465418, 1.469460, -0.654249,
    0.174065, -0.625879, -0.105627, 0.792040, -1.772899, 0.728948, 0.468900, 0.196008,
    0.268871, 0.920961, 0.463799, 0.175189, 0.843505, -0.472169, -1.078900, 0.797251,
    0.210414, -1.982422, 1.009734, 0.460874, -0.447698, 0.630579, 0.852527, 0.740813,
    0.746702, 0.572734, -0.589015, 0.376256, 0.199340, 1.040441, -0.355435, 1.120113,
    0.166867,
])
BLOCK_MARK_SMEARING_CORRECTION = 0.950
BLOCK_MARK_POSITIVE_MIN = 0.02
BLOCK_MARK_POSITIVE_MAX = 2172.012
# 실적에서 MARK=0인 10개 블록은 모두 길이 8,845mm 이하였다. 이 구간에서만 0을 허용하고
# 구간 내 조건부 확률(10/176)을 적용하면 전체 영값 비율 1.27%가 자동으로 재현된다.
BLOCK_MARK_ZERO_LENGTH_MAX = 8845.0
BLOCK_MARK_ZERO_CONDITIONAL_RATE = 0.0568

# [수정 2] 베벨 허들을 블록 단위와 W/O 단위 2단계로 분리한다.
# W/O 단위 허들만 쓰면 베벨이 블록 내에서 독립 사건이 되어 '베벨 없는 블록'이
# 실적 39.8% 대비 22.8%로만 나오고, 실제 생성 결과는 3.5%까지 붕괴했다.
# 베벨 가공 여부는 블록 단위로 뭉치므로 블록 허들을 먼저 통과해야 한다.
BLOCK_BEVEL_HURDLE_B0 = 0.4959
BLOCK_BEVEL_HURDLE_B1 = 0.8016
BLOCK_BEVEL_THK_MEAN = 14.201736
BLOCK_BEVEL_THK_STD = 2.607596
BLOCK_CUT_A = 1.7056
BLOCK_CUT_B = 59.21
...
def _generate_block_seed_values(
    ...
    # [수정 1] 허들 + 로그선형. 짧은 블록에서만 0이 나올 수 있고, 양수는 로그공간에서
    # 생성되므로 하한 절단으로 인한 경계 뭉침이 발생하지 않는다.
    if (
        block_length <= BLOCK_MARK_ZERO_LENGTH_MAX
        and rng.random() < BLOCK_MARK_ZERO_CONDITIONAL_RATE
    ):
        block_mark = 0.0
    else:
        log_residual = float(
            BLOCK_MARK_LOG_RESIDUALS[rng.integers(0, len(BLOCK_MARK_LOG_RESIDUALS))]
        )
        block_mark = float(
            np.exp(
                BLOCK_MARK_LOG_A * np.log(block_length)
                + BLOCK_MARK_LOG_B
                + log_residual
            )
            * BLOCK_MARK_SMEARING_CORRECTION
        )
        block_mark = float(
            np.clip(block_mark, BLOCK_MARK_POSITIVE_MIN, BLOCK_MARK_POSITIVE_MAX)
        )
...
def _generate_work_order_rows(
    ...
    # [수정 2] 1단계 - 이 블록에 베벨 가공이 있는가. 블록 평균 두께 기준 로지스틱.
    # 통과하지 못하면 블록 내 모든 W/O의 BVL_LTH가 0이 되어 실적의 영값 비율(39.8%)이
    # 복원된다. 기존에는 이 단계가 없어 베벨 없는 블록이 3.5%까지 줄었다.
    block_bevel_probability = 1.0 / (
        1.0
        + np.exp(
            -(
                BLOCK_BEVEL_HURDLE_B0
                + BLOCK_BEVEL_HURDLE_B1
                * (block_thickness - BLOCK_BEVEL_THK_MEAN)
                / BLOCK_BEVEL_THK_STD
            )
        )
    )
    block_has_bevel = bool(rng.random() < block_bevel_probability)
    ...
    for wo_index, (length, thickness, cut_length, mark_length) in enumerate(
        ...
        # 2단계 - 베벨 블록 안에서 어느 W/O에 실제로 걸리는가(기존 식 유지).
        if not block_has_bevel:
            bevel_length = 0.0
        else:
            bevel_length = max(
                0.0,
